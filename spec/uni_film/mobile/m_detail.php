	<section>
				...
				<div class="spec-board-region">
					...
					<div class="div-spec-add-feed">
						<p>您的名字:&nbsp;</p><input type="text" style="width: 50%; margin-bottom: 10px; float: left;" class="form-control input-sm" name="user" id="user" required="" placeholder="您的名字" value="<?php if ($username != "") {echo $username;} ?>">
						...
						<div>
							...
							<textarea class="comment-textarea" placeholder="您的留言..." title="您的留言..." value="您的留言..." style="resize: none; overflow-y: hidden; position: absolute; top: 0px; left: -9999px; height: 99px; width: 446px; line-height: 24px; text-decoration: none; letter-spacing: 0px;" tabindex="-1"></textarea>
							<textarea class="comment-textarea" placeholder="您的留言..." title="您的留言..." value="您的留言..." style="resize: none; overflow-y: hidden; position: absolute; top: 0px; left: -9999px; height: 99px; width: 446px; line-height: 24px; text-decoration: none; letter-spacing: 0px;" tabindex="-1"></textarea> -->
							<p>您的留言: </p><textarea class="comment-textarea form-control" style="width: 60%; margin-bottom: 10px;" id="comment-textarea" placeholder="您的留言..." title="您的留言..." value="您的留言..." style="resize: none; overflow-y: hidden;"></textarea>
						</div>
