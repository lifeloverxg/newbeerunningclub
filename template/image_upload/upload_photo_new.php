<!--         <section class="section-upload-photo-new">
            <div id="main">
                <h1>上传照片</h1>
...
<div id="main">
    <div id="body" class="light">
        <div id="content" class="show">
            <div class="demo">
                <form id="uploadForm" action="../template/image_upload/upload.php" method="post" enctype="multipart/form-data">
                    <div class="upload_box">
                        <div class="upload_main">
                            <div class="upload_choose">
                                <input id="fileImage" type="file" size="30" name="fileselect[]" multiple />
...
<script src="../js/zus/photo/zxxFile.js"></script>
<script>
var params = {
