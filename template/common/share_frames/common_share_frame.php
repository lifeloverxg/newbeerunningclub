			...
			<div class="display-block-small">
				...
				<div class="nycuni-wechat-public">
					<div class="div-share-content">
						...
						<div class="div-share-font" style = "width: 100%; text-align: center;"><span style="font-size: 1 rem;">NewBee Running Club</span><br><span style="">纽约新蜂跑团</span><br><span style="color: rgba(2, 2, 2, 0.6);">微信公共平台</span></div>
					</div>
				</div>
