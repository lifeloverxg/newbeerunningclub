...
+function ($) { "use strict";
  ...
  Fileupload.prototype.clear = function(e) {
    ...
    if (e !== false) {
      ...
      /*+++++ yi upload test +++++*/
      var fui_yi_test = $("#fui-fileinput-imageUpload").html()
      if ( !(typeof(fui_yi_test) == "undefined") && (fui_yi_test != '') )
      {
      }
      else if ( typeof(fui_yi_test) == "undefined" )
      {

      }
      else
      {
        var home = $("#fui-fileinput-imageUpload-home").val()
        ...
        {
          var html = "<img src='"+home+"theme/images/default_upload_logo.jpg' style='width: 240px; height: 160px;'/>"
        }
        $("#fui-fileinput-imageUpload").append(html)
      }
    }
  },
