...
(function($) {
  ...
  $(function() {
    ...
    var datepickerSelector_2 = '#datepicker-02';
    ...
    // $(datepickerSelector_2).val($(datepickerSelector).val());

    $(datepickerSelector_2).datepicker({
      showOtherMonths: true,
      selectOtherMonths: true,
      dateFormat: "d MM, yy",
      yearRange: '-1:+1'
      ...
      e && e.preventDefault();
      $(datepickerSelector_2).focus();
    });
    $.extend($.datepicker, {_checkOffset:function(inst,offset,isFixed){return offset}});

    // Now let's align datepicker with the prepend button
    $(datepickerSelector_2).datepicker('widget').css({'margin-left': -$(datepickerSelector_2).prev('.input-group-btn').find('.btn').outerWidth()});
