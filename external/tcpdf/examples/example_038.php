...
$pdf->Cell(20, 10, '敏捷的棕毛狐狸跃过那只懒狗。', '',1, 1, 'C');
$pdf->Cell(30, 10, 'The quick brown fox jumps over the lazy dog.', '',1, 1, 'C');
$pdf->Cell(30, 10, '1234567890', '',1, 1, 'C');

// add a page
$pdf->AddPage();

$txt = '易峻霄 of CID-0 CJK unembedded font.
...
$pdf->Output('new_folder/example_038.pdf', 'f');
