<?php
    ...
    $info_list = EventDAO::get_info_list($args['pid'], $args['eid']);
    ...
    $custom             =   $args['pid']."nycuni".$args['eid']."nycuni".$info_list['title'];
...
$pdf->Output($ticket_url, 'f');
    ...
    if ( $error == "none" )
    {
        ...
        $args['list'] = "您的订单确认信已经发到您的邮箱<br>请登录您的邮箱查收, 两秒后将自动跳转到活动页面";
        $args['param'] = true;
    }
