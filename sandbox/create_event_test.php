...
?>
			...
			<div class="div-popu" id="create-event">
				...
				<!-- <section class="popup-main"> -->
					...
					<article class="create-form create-event-form">
						<form id="eventForm" name="eventForm" method="post" action="<?php echo $home . "cgi/formActions/uni_form_common.php"; ?>" enctype="multipart/form-data" onSubmit="return event_check(this)">					
