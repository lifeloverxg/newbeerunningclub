...
$bm = new Timer();
	...
	$test = EventDAO::ipn_handle("hello world");
$bm->mark();
	...
	*/
	if ($verified)
	{
	    ...
	    */
	    mail('lifeloverxg@gmail.com', 'Verified IPN', $listener->getTextReport());
	    $test = EventDAO::ipn_handle("hello world");
	    ...
	    invalid IPN.
	    */
	    mail('lifeloverxg@gmail.com', 'Invalid IPN', $listener->getTextReport());
	}
echo '<!-- '.$bm->report().'-->';
?>